...
"""
==================Coletar apenas 1 ativo direto do terminal==================

/opt/anaconda3/bin/python3 - << 'EOF'
import yfinance as yf
df = yf.download("PETR4.SA", period="5d", progress=False)
print(df.tail())
EOF

======================Rodar esse py direto do terminal=======================
/opt/anaconda3/bin/python3 coleta_precos.py

==========================Editar o .plist (launchd)==========================
nano ~/Library/LaunchAgents/com.dfsenra.coleta.precos.plist
Faz alterações
...
launchctl unload ~/Library/LaunchAgents/com.dfsenra.coleta.precos.plist
launchctl load ~/Library/LaunchAgents/com.dfsenra.coleta.precos.plist

Force a execução manual:
launchctl kickstart -k gui/$(id -u)/com.dfsenra.coleta.precos

Para validar que funcionou:
tail -n 50 ~/Documents/2.\ Documentos/Finanças/Investimentos/logs/launchd.err
tail -n 50 ~/Documents/2.\ Documentos/Finanças/Investimentos/logs/launchd.out
tail -n 50 ~/Documents/2.\ Documentos/Finanças/Investimentos/logs/coleta.log
